...
<head>
    <meta charset="utf-8" />
    <title>Rey Fitnes | Lupa Password</title>
    ...
    <div class="login-container">
        <div class="login-box text-center">
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <button type="submit" class="btn btn-login w-100">Lupa Password</button>
            </form>
            ...
            <div class="row login-footer mt-3">
                ...
                <div class="col">
                    <a href="{{ route('login') }}" class="btn btn-home mt-3 w-100">Masuk</a>
                </div>
