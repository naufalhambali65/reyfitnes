    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <form action="{{ route('product-stocks.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="card-header d-flex align-items-center">
                        <h2 class="card-title mb-0 fw-bold">
                            <i class="fas fa-plus me-2 text-primary"></i> Form Produk
                        </h2>
                        <div class="ms-auto">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                                        placeholder="Harga" name="price" value="{{ old('price') }}" required
                                        step="0.01" min="0" />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('cost') is-invalid @enderror"
                                        placeholder="Harga Modal" name="cost" value="{{ old('cost') }}" step="0.01"
                                        min="0" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                        placeholder="Stok" name="stock" value="{{ old('stock', 0) }}" min="0"
                                        required />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('min_stock') is-invalid @enderror"
                                        placeholder="Minimal Stok" name="min_stock" value="{{ old('min_stock', 0) }}"
                                        min="0" required />
