        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card shadow-sm p-3 position-relative">
                ...
                <div class="text-center">
                    <img src="{{ $class->trainer->user->image ? asset('storage/public/' . $class->trainer->user->image) : '/homepage_assets/img/default-profil.png' }}"
        ...
        <div class="col-md-8">
            ...
            {{-- <div class="card shadow-sm p-3 mt-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="text-center">
                        <img src="{{ $class->image ? asset('storage/public/' . $class->image) : '/homepage_assets/img/default-profil.png' }}"
                            class="img-fluid rounded mb-3" style="max-width: 220px; object-fit: cover;">
                    </div>
                </div>
            </div> --}}
