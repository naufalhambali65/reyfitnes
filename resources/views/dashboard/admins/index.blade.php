            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h2 class="card-title mb-0 fw-bold">
                        <i class="fas fa-users me-2 text-primary"></i> Semua Admin
                    </h2>
                    <div class="ms-auto">
                                ...
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-capitalize fw-semibold">{{ $admin->name }}</span>
                                            <br>
                                            <span class="text-lowercase text-muted">{{ $admin->email }}</span>
                                        </td>
                                        ...
                                        <td class="text-center align-middle d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{ route('admins.toggleRole', $admin->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('PUT')
    ...
    <script>
        $(function() {
            ...
            $("#dataTable").DataTable({
                ...
                autoWidth: false,
                language: {
                    emptyTable: '<i class="fas fa-info-circle me-1"></i> Anda belum memiliki admin.'
                },
