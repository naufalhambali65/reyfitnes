    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <form method="post" action="{{ route('memberships.update', $membership->slug) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-header d-flex align-items-center">
                        <h2 class="card-title mb-0 fw-bold">
                            <i class="fas fa-pencil-alt me-2 text-primary"></i> Edit Paket membership
                        </h2>
                        <div class="ms-auto">
                        ...
                        <div class="row p-3">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_days') is-invalid @enderror"
                                        ...
                                        value="{{ old('duration_days', $membership->duration_days) }}" min="0">
                                    @error('duration_days')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="decimal" class="form-control @error('price') is-invalid @enderror"
                                        id="price" name="price" autofocus
                                        value="{{ old('price', $membership->price) }}" min="0">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="available" @selected(old('status', $membership->status) == 'available')>
                                            Tersedia
                                        </option>
                                        <option value="unavailable" @selected(old('status', $membership->status) == 'unavailable')>
                                            Tidak Tersedia
                                        </option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input id="features" type="hidden" name="features"
                                        value="{{ old('features', $membership->features) }}"
