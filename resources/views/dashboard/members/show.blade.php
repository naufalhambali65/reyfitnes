        ...
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm p-3">
                ...
                <div class="text-center">
                    ...
                    <img src="{{ $user->image ? asset('storage/public/' . $user->image) : '/homepage_assets/img/default-profil.png' }}"
            ...
            <div class="card shadow-sm p-3 mt-3">
                ...
                @if ($activeMembership && $activeMembership->qr_code)
                    <div class="text-center">
                        <img src="{{ asset('storage/public/' . $activeMembership->qr_code) }}" alt="QR Code Member"
                        ...
                        <!-- Tombol Download QR -->
                        <a href="{{ asset('storage/public/' . $activeMembership->qr_code) }}"
