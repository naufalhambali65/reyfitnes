    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <form method="post" action="{{ route('banks.update', $bank->slug) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-header d-flex align-items-center">
                        <h2 class="card-title mb-0 fw-bold">
                            <i class="fas fa-pencils me-2 text-primary"></i> Edit Rekening Bank
                        </h2>
                        <div class="ms-auto">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active" @selected(old('status', $bank->status) == 'active')>
                                            Aktif
                                        </option>
